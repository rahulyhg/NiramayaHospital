...
public class PrescriptionAdvisedListAdapter extends RecyclerView.Adapter<PrescriptionAdvisedListAdapter.MyViewHolder> {

    private ArrayList<CreatePrescriptionAdvisedModel> prescriptionList;
    private Context mContext;

    public PrescriptionAdvisedListAdapter(ArrayList<CreatePrescriptionAdvisedModel> pastHistoryList, Context mContext) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        CreatePrescriptionAdvisedModel prescriptionModel = prescriptionList.get(position);
